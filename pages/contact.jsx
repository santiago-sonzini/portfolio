    ...
    <main className=" h-screen w-full flex-col flex items-center justify-center  dark:bg-[#1D1B26]">
        ...
        <form onSubmit={(e)=>{
            ...
            <input value={name} onChange={(e)=>{
                ...
                }} type="text" placeholder='Name' className=' p-4 m-1 w-2/5 bg-transparent border border-violet-600 rounded-md focus:outline-none focus:border-2 text-white  text-center'/>
