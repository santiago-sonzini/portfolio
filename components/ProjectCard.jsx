...
const ProjectCard = ({project}) => {
    ...
    console.log('====================================');
  return (
    <div className='  w-3/4 md:w-2/3 lg:w-1/3 lg:h-2/3  md:h-2/3 p-8 bg-[#1D1B26] m-5 rounded-md border border-violet-600 flex flex-col hover:translate-y-1.5 transition-all duration-300 justify-center'>
       ...
       <span className='flex items-center'>
        <a  rel="noreferrer" target="_blank" href={project.url} >
            <h3 className='  text-center  text-violet-400 font-extrabold text-3xl m-2 hover:underline transition-all duration-500 ' >{project.name} </h3>
        </a>
