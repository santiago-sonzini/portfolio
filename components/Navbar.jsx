...
const Navbar = () => {
  ...
  return (
    <nav className='  bg-[#1D1B26] flex  self-start justify-self-start justify-between  w-full'>
        ...
        <h2 className=' font-extrabold border-4 shadow-violet-700 shadow-md border-violet-700  p-4 rounded-md  flex items-center justify-between  '>Language <IoLanguage className=' m-1 font-extrabold'/></h2>
